<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="orphanagemanagement.Home" %>
  ...
  <div class="collapse navbar-collapse  " id="navbarNav">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
        <a class="nav-link" href="Login.aspx">Donate</a>
      </li>
        </ul>
        <ul class="navbar-nav">
         <li class="nav-item ">
        ...
        <div class="jumbotron text-center align-text-top" style="background-color:#00F3FF"> 
            <h1 class="text-danger">Happy Home</h1>
               </div>
