<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="orphanagemanagement.Contact" %>
...
<body>
  ...
  <div class="row no-gutters">
    <div class="col-md-4">
      <img src="images/pic1.jpg" class="card-img" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title">Neeerav Patil</h5>
        <p class="card-text">Founder of the Happy Home.</p>
  ...
  <div class="row no-gutters">
    <div class="col-md-4">
      <img src="images/piccc.jpg" class="card-img" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title">Vishal Jaiswar</h5>
        <p class="card-text">Co-Founder of Happy Home.</p>
